        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            <img 
              ...
              className="h-20 w-auto mb-2 filter brightness-200"
            />
            <h3 className="text-xl font-bold mb-1" style={{ color: COLORS.TEXT_MAIN, fontFamily: 'var(--font-heading)' }}>United Hacks V6</h3>
            <p className="text-sm" style={{ color: COLORS.TEXT_MUTED, fontFamily: 'var(--font-body)' }}>
              EIN: 81-2908499
            </p>
            <div className="flex justify-center md:justify-start space-x-4 mt-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  title={link.name}
                >
                  <img src={link.icon} alt={link.name} className="w-6 h-6 filter invert hover:opacity-75 transition-all duration-300" />
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="text-center md:text-left mt-8 md:mt-0">
            <h3 className="text-lg font-semibold mb-4" style={{ color: COLORS.TEXT_MAIN, fontFamily: 'var(--font-heading)' }}>Company</h3>
            <div className="space-y-2 flex flex-col items-center md:items-start" style={{ fontFamily: 'var(--font-body)' }}>
              {companyLinks.map((link) => (
                <a key={link.name} href={link.href} target="_blank" rel="noopener noreferrer" className="transition-colors" style={{ color: COLORS.TEXT_MUTED }}>
                  {link.name}
                </a>
              ))}
            </div>
          ...
          {/* Contact Links */}
          <div className="text-center md:text-left mt-8 md:mt-0">
            <h3 className="text-lg font-semibold mb-4" style={{ color: COLORS.TEXT_MAIN, fontFamily: 'var(--font-heading)' }}>Contact Us</h3>
            <div className="space-y-2 flex flex-col items-center md:items-start" style={{ fontFamily: 'var(--font-body)' }}>
